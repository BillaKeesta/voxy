...
public final class VoxySableDepthShim {
    ...
    private static final FullscreenBlit COPY_DEPTH = new FullscreenBlit("voxy:post/depth_copy.frag");
    private static final FullscreenBlit TRANSFORM_DEPTH = new FullscreenBlit("voxy:post/blit_texture_depth_cutout.frag");
    private static final FullscreenBlit COPY_CHANGED_DEPTH = new FullscreenBlit("voxy:post/depth_copy_changed.frag");
